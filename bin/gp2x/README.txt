...
Touchscreen support added (as of 0.5) - see instructions below.
...
Single tap menus to simply highlight the item or double tap to select/action the item.
Double tapping on a blank area of screen will usually act like pressing B to move on or
back to the previous screen.
In-play, single tap a letter to select it into the lower row, or unselect it back to the 
top row. The four icons beside the play letters act as the A,B,X,Y buttons on the console.
On completing a level, single tap a blue or red word to see a brief definition, or double 
tap to see a full definition. Tap scroll arrows to view more of a long definition, and double 
tap the screen background to return to the previous screen.
...
Version History:
================
0.5		18.06.2008	Updates:
		Added GP2XF200 touchscreen support:
			Many thanks to Micah Stetson for initial code, testing and support
		Changed volume control routine to handle all sound including .mod files
		Added (touchable) scroll arrows where needed
