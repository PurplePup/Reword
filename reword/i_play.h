...
{
public:
	enum eSuccess { SU_NONE=0, SU_ARCADE, SU_GOT6, SU_BONUS, SU_BADLUCK, SU_SPEEDER, SU_TIMETRIAL, SU_GAMEOVER, SU_SAVEEXIT };
    ...
    virtual bool button(Input* /*input*/, ppkey::eButtonType /*b*/) = 0;
